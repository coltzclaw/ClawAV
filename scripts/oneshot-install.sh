...
#   curl -sSL https://raw.githubusercontent.com/coltz108/ClawAV/main/scripts/oneshot-install.sh | sudo bash -s -- --version v0.3.1b
...
BASE_URL="https://github.com/$REPO/releases/download/$VERSION"
CLAWTOWER_ARTIFACT="clawav-${ARCH_LABEL}-linux"
CLAWSUDO_ARTIFACT="clawsudo-${ARCH_LABEL}-linux"

log "Downloading $CLAWTOWER_ARTIFACT..."
curl -sSL -f -o "$TMPDIR/clawav" "$BASE_URL/$CLAWTOWER_ARTIFACT" || die "Failed to download clawav binary. Does $VERSION exist? Check: $BASE_URL/$CLAWTOWER_ARTIFACT"
