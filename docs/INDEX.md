...
| Document | What's in it |
|----------|-------------|
| [KEY-RESET.md](../docs/KEY-RESET.md) | Lost your admin key but have root? Reset it in 5 commands |
| [RECOVERY.md](../docs/RECOVERY.md) | Lost everything — single-user mode, live USB, and cloud recovery |
